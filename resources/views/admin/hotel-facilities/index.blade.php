...
<h1 class="h2" style="color: white">Data Fasilitas Hotel</h1>
    ...
    <table class="table table-sm table-bordered table-white border-white text-center" style="color: white">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="{{ asset('storage/' . $hotel_facility->image) }}" alt="Gambar {{ $hotel_facility->facility_name }}" width="650" class="img-fluid"></td>
                <td>
