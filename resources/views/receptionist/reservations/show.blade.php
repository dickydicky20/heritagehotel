    ...
    <div class="card bg-light">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                <br> <button type="button" class="btn btn-sm btn-primary mt-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    Update Status
                </button>
                 <a href="{{ route('reservations.index') }}" class="btn btn-primary mb-20"> back </a>
            </p>
        </div>
    </div>
</div>
